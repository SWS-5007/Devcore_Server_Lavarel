    ...
    */
    ...
    'route' => [
        ...
        'middleware' => [
            ...
            \App\Http\Middleware\ApiAuthenticate::class . ':api',
            \App\Http\Middleware\Lang::class,
            \App\Http\Middleware\InitContext::class . ':graphql,api',
...
//           #\Nuwave\Lighthouse\Support\Http\Middleware\LogGraphQLQueries::class,
    ...
    */
    ...
    'namespaces' => [
        ...
        'directives' => ['App\\GraphQL\\Directives', 'App\\Lib\GraphQL\\Directives'],
    ],
    ...
    */
    ...
    'error_handlers' => [
        ...
        \App\Lib\GraphQL\Exceptions\ExtensionErrorHandler::class,
    ],
    ...
    */
    ...
    'custom' => [
        'metadataResolver' => \App\GraphQL\Resolvers\MetadataResolver::class . '@getObjectMetadata',
    ],
