...
class ProcessStatsLoader extends BatchLoader
{
    /**
     * @var Builder
     */
    ...
    public function resolve(): array
    {
        ...
        $result = $this->builder
            ->withCount([
                'stages', 'operations', 'phases', 'ideas', 'issues', 'toolIdeas', 'projects',
